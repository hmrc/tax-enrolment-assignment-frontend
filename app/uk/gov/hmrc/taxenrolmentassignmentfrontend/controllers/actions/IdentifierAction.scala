...
class IdentifierActionImpl @Inject() ()(implicit val executionContext: ExecutionContext) extends IdentifierAction {
  ...
  override protected def transform[A](request: RequestWithUserDetailsFromSession[A]): Future[IdentifierRequest[A]] = {
...
trait IdentifierAction extends ActionTransformer[RequestWithUserDetailsFromSession, IdentifierRequest]
