...
object FeatureFlagName {
  ...
  val allFeatureFlags =
    List(
      PtNinoMismatchCheckerToggle
    )
}

case object PtNinoMismatchCheckerToggle extends FeatureFlagName {
  override def toString: String = "pt-nino-mismatch-checker-toggle"

  override val description: Option[String] = Some(
    "If enabled, make a call to delete potential HMRC-PT NINO enrolments if they differ from the NINO in the auth request"
  )
}
