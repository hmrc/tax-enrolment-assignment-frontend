...
import uk.gov.hmrc.taxenrolmentassignmentfrontend.messages.EnrolCurrentUserMessages
import uk.gov.hmrc.taxenrolmentassignmentfrontend.views.html.EnrolCurrentUser

class EnrolCurrentUserSpec extends TestFixture {
  ...
  object Selectors {
    ...
    val warning = "govuk-warning-text__text"
